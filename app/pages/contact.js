...
export default function Contact({ contact, menuItems }) {
  ...
  if (shouldShowSanityPreviewFallback(contact, menuItems)) {
    return (
      <MainLayout>
      ...
      <section className="container page" style={{ opacity: 0 }}>
        ...
        <section id="contact">
          {width < 992 && (
            <div className="top">
              <h1 className="white">
                <a className="no-underline white" onClick={() => handleNavigation("/")}>
          ...
          <div className="footer-container">
            {width > 992 ? <Footer leftCol={false} transparent={true} /> : <Footer leftCol={true} transparent={true} />}
          </div>
        </section>
      </section>
    </MainLayout>
